...
async function showForm() {
    ...
    const form1 = await makeVisible("updateForm");
    const form2 = await makeVisible("labelforUpdatedTitle");
    const form3 = await makeVisible("gameTitleUpdated");
    const form4 = await makeVisible("labelForUpdatedDescription");
    const form5 = await makeVisible("gameDescriptionUpdated");
    const form6 = await makeVisible("labelForUpdatedImage");
    const form7 = await makeVisible("gameImageUrlUpdated");
    const form8 = await makeVisible("saveBtn");
    const form9 = await makeVisible("cancelBtn");
}
